...
static constexpr u16 const* get_scan(TransformSize transform_size, TransformSet transform_set)
{
...
static constexpr TransformSet mode_to_txfm_map[MB_MODE_COUNT] = {
    TransformSet::DCT_DCT,   // DC
    TransformSet::ADST_DCT,  // V
    TransformSet::DCT_ADST,  // H
    TransformSet::DCT_DCT,   // D45
    TransformSet::ADST_ADST, // D135
    TransformSet::ADST_DCT,  // D117
    TransformSet::DCT_ADST,  // D153
    TransformSet::DCT_ADST,  // D207
    TransformSet::ADST_DCT,  // D63
    TransformSet::ADST_ADST, // TM
    TransformSet::DCT_DCT,   // NEARESTMV
    TransformSet::DCT_DCT,   // NEARMV
    TransformSet::DCT_DCT,   // ZEROMV
    TransformSet::DCT_DCT,   // NEWMV
};
